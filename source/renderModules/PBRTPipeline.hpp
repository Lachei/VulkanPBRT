...
public:
    PBRTPipeline(vsg::ref_ptr<vsg::Node> scene, vsg::ref_ptr<GBuffer> g_buffer,
        vsg::ref_ptr<AccumulationBuffer> accumulation_buffer, vsg::ref_ptr<IlluminationBuffer> illumination_buffer,
    ...
    void add_trace_rays_to_command_graph(
...
private:
    void setup_pipeline(vsg::Node* scene, bool use_external_g_buffer);
    ...
    vsg::ref_ptr<AccumulationBuffer> _accumulation_buffer;
