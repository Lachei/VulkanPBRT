...
public:
    ...
    BFRBlender(uint width, uint height, 
        ...
        auto descriptorSet = vsg::DescriptorSet::create(descriptorSetLayout, vsg::Descriptors{
            vsg::DescriptorImage::create(averageImage->imageInfoList[0], averageBinding, 0 , VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
            vsg::DescriptorImage::create(averageSquaredImage->imageInfoList[0], averageSquaredBinding, 0 , VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
            vsg::DescriptorImage::create(denoised0->imageInfoList[0], denoised0Binding, 0 , VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
            vsg::DescriptorImage::create(denoised1->imageInfoList[0], denoised1Binding, 0 , VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
            vsg::DescriptorImage::create(denoised2->imageInfoList[0], denoised2Binding, 0 , VK_DESCRIPTOR_TYPE_STORAGE_IMAGE),
            finalImage
        });
    ...
    void copyFinalImage(vsg::ref_ptr<vsg::Commands> commands, vsg::ref_ptr<vsg::Image> dstImage){
        ...
        pipelineBarrier = vsg::PipelineBarrier::create(VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_PIPELINE_STAGE_COMPUTE_SHADER_BIT, VK_DEPENDENCY_BY_REGION_BIT,
                            srcBarrier, dstBarrier);
        commands->addChild(pipelineBarrier);
    }
