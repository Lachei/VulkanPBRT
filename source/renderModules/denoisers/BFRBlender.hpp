...
{
public:
    BFRBlender(uint32_t width, uint32_t height, vsg::ref_ptr<vsg::DescriptorImage> average_image,
...
private:
    uint32_t _average_binding = 0, _average_squared_binding = 1, _denoised0_binding = 2, _denoised1_binding = 3,
             _denoised2_binding = 4, _final_binding = 5;
